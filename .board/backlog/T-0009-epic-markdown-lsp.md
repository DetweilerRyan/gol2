...
| T-0004 | Spike: can a relay keep rumdl's LSP results fresh after shell and git changes? Runs only after T-0008 recommends go   |
...
flowchart LR
  ...
  T0008 --> D2{"Benefit<br/>go?"}
  D2 -->|go| T0004["T-0004<br/>freshness spike"]
  T0004 --> D3{"Freshness<br/>go?"}
  D3 -->|go| T0002["T-0002<br/>plugin"]
...
- **After T-0005's pilot:** the user decides whether to run T-0008. If not, T-0008, T-0004, T-0002, T-0007, T-0001,
  and T-0003 move to `dropped/`.
- **After T-0008:** T-0004 (the freshness spike) runs only if the benefit study recommends go. Otherwise T-0004,
  T-0002, T-0007, T-0001, and T-0003 move to `dropped/`.
