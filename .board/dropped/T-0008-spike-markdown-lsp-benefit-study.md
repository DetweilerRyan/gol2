...
acceptance:
  ...
  - "A grader agent proposes the answer-key matches and citation checks from redacted, condition-hidden outputs, and the user confirms every proposed match before it counts; the evidence records the proposals and the user's confirmations"
